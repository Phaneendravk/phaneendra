...
function education(){
   ...
   document.getElementById('p2').innerHTML="UI/UX design training at Digital Lync Institute";
   document.getElementById('p3').innerHTML="2020-2023";
   document.getElementById('p4').innerHTML="B-tech";
   document.getElementById('p5').innerHTML="2017";
   document.getElementById('p6').innerHTML="SSC";
